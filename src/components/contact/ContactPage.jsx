...
import ParticleEffect from "../home/ParticleEffect";
      ...
      <div className="min-h-dvh w-full px-8 flex flex-col items-center text-slate-900">
        <div className="max-w-[72em] w-full flex flex-col">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full mt-8">
            ...
            <iframe className="border-2 h-72 w-full md:h-full border-slate-200 rounded-2xl" allowFullScreen={true}  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3464.9925263890127!2d-95.40280908488693!3d29.719975740782047!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x68cceacce233949!2sDepartment+of+Mechanical+Engineering+and+Materials+Science!5e0!3m2!1sen!2sus!4v1501714104659" />
          </div>
...
function Contact({name, href, info, icon}) {
  ...
  return (
    <a href={href} target="_blank" rel="noreferrer">
      <div className="group flex flex-col justify-between max-w-56 max-h-56 w-56 h-56 md:w-[22vw] md:h-[22vw] border-2 border-blue p-4 bg-white hover:bg-blue hover:text-white ease-in-out duration-200">
